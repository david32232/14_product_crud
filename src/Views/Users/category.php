        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="category" class="nav-item nav-link active">Categories</a>
    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <?php foreach($onetopic as $sp): ?>
                <span class="breadcrumb-item active"><?= $sp['topic'] ?></span>
                <?php endforeach ?>
            </nav>
        </div>
    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                ...
                                <div class="overlay position-relative bg-light">
                                    ...
                                    <a class="h4" href="single?id=<?php echo $post['ID'] ?>"><?= $post['title'] ?></a>
                                    <p class="m-0">
                                    <?php
                                        $maxLength = 200;
                        ...
                        <?php foreach($posts as $sp): ?>
                            <div class="col-lg-6">
                                <div class="d-flex mb-3">
                                    <img src="<?= $sp['image'] ?>" style="width: 100px; height: 100px; object-fit: cover;">
                                    <div class="w-100 d-flex flex-column justify-content-center bg-light px-3" style="height: 100px;">
                                        <div class="mb-1" style="font-size: 13px;">
                                            <a href="category?id=<?php echo $post['topic'] ?>"><?= $sp['topic'] ?></a>
                                            <span class="px-1">/</span>
                                            <span><?= $sp['created-at'] ?></span>
                                        </div>
                                        <a class="h6 m-0" href="single?id=<?php echo $post['ID'] ?>"><?= $sp['title'] ?></a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach ?>
